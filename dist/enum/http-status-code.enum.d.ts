export declare enum HttpStatusCode {
     ...
     * to later send an asynchronous response indicating the outcome of processing the request. It is intended for cases
     ...
     *
     * The server rejected the request because the Content-Length header field is
     ...
     *
     * This response code means that URI of requested resource has been changed temporarily. New changes in the URI
     ...
     *
     * This response code is sent after accomplishing request to tell user agent reset document view which
     * sent this request.
     */
    RESET_CONTENT = 205,
    /**
     ...
     *
     * This code is sent in response to an Upgrade request header by the client, and indicates the protocol the server
     * is switching too.
     */
     ...
     *
     * Server sent this response to directing client to get requested resource to another URI with same method that
     * used prior request. This has the same semantic than the 302 Found HTTP response code, with the exception that
     * the user agent must not change the HTTP method used: if a POST was used in the first request, a POST must be
...
//# sourceMappingURL=http-status-code.enum.d.ts.map